...
<template>
	<div class="relative">
		...
		<div :id="dropdownName"
			...
			<ul class="text-md py-2 text-gray-700 dark:text-gray-200" :aria-labelledby="`${dropdownName}-button`">
				<li @click="
					() =>
				...
				">
					<div class="flex items-center">
						<input :checked="modelValue.pending" type="checkbox" value=""
						...
						<label for="checked-checkbox"
							class="text-md ml-2 font-medium text-gray-900 dark:text-gray-300">Pendientes</label>
					</div>
				</li>
				...
				">
					<div class="flex items-center">
						<input :checked="modelValue.partial" type="checkbox" value=""
						...
						<label for="checked-checkbox"
							class="text-md ml-2 font-medium text-gray-900 dark:text-gray-300">Parciales</label>
					</div>
				</li>
				...
				">
					<div class="flex items-center">
						<input :checked="modelValue.completed" type="checkbox" value=""
						...
						<label for="checked-checkbox"
							class="text-md ml-2 font-medium text-gray-900 dark:text-gray-300">Completados</label>
					</div>
				</li>
				...
				<li @click="goToDetails">
					<div class="flex items-center">
						<InfoIcon />
						<label for="checked-checkbox"
							class="text-md ml-2 font-medium text-gray-900 dark:text-gray-300">Números</label>
					</div>
				</li>
			</ul>
		</div>

		<button type="button" :id="`${dropdownName}-button`" :data-dropdown-toggle="dropdownName"
